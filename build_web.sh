...
odin build source/main_web -o:speed -target:js_wasm32 -build-mode:obj -define:RAYLIB_WASM_LIB=env.o -define:RAYGUI_WASM_LIB=env.o -strict-style -out:$OUT_DIR/game.wasm.o
...
flags="-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -sINITIAL_HEAP=2147483648 -sEXPORTED_RUNTIME_METHODS=["HEAPF32"] --shell-file source/main_web/index_template.html"
