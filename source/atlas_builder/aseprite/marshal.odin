...
marshal_to_file :: proc(
	...
	w, ok := io.to_writer(os.to_stream(f))
	if !ok {
		return file_size, .Unable_Make_Writer
	}
	return marshal(doc, w, allocator)
