...
// Begin JS library code
  ...
  function _tick_now(...args
  ) {
  abort('missing function: tick_now');
  }
  _tick_now.stub = true;
...
var ASM_CONSTS = {
  7870222: () => { if (document.fullscreenElement) return 1; },  
 7870268: () => { return Module.canvas.width; },  
 7870300: () => { return parseInt(Module.canvas.style.width); },  
 7870348: () => { document.exitFullscreen(); },  
 7870375: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 7870447: () => { if (document.fullscreenElement) return 1; },  
 7870493: () => { return Module.canvas.width; },  
 7870525: () => { return screen.width; },  
 7870550: () => { document.exitFullscreen(); },  
 7870577: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 7870771: () => { return window.innerWidth; },  
 7870797: () => { return window.innerHeight; },  
 7870824: () => { if (document.fullscreenElement) return 1; },  
 7870870: () => { return Module.canvas.width; },  
 7870902: () => { return parseInt(Module.canvas.style.width); },  
 7870950: () => { if (document.fullscreenElement) return 1; },  
 7870996: () => { return Module.canvas.width; },  
 7871028: () => { return screen.width; },  
 7871053: () => { return window.innerWidth; },  
 7871079: () => { return window.innerHeight; },  
 7871106: () => { if (document.fullscreenElement) return 1; },  
 7871152: () => { return Module.canvas.width; },  
 7871184: () => { return screen.width; },  
 7871209: () => { document.exitFullscreen(); },  
 7871236: () => { if (document.fullscreenElement) return 1; },  
 7871282: () => { return Module.canvas.width; },  
 7871314: () => { return parseInt(Module.canvas.style.width); },  
 7871362: () => { document.exitFullscreen(); },  
 7871389: ($0) => { Module.canvas.style.opacity = $0; },  
 7871427: () => { return screen.width; },  
 7871452: () => { return screen.height; },  
 7871478: () => { return window.screenX; },  
 7871505: () => { return window.screenY; },  
 7871532: () => { return window.devicePixelRatio; },  
 7871568: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 7871621: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 7871672: () => { Module.canvas.style.cursor = 'none'; },  
 7871709: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 7871965: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 7872016: () => { if (document.pointerLockElement) return 1; },  
 7872063: () => { if (document.fullscreenElement) return 1; },  
 7872109: () => { return window.innerWidth; },  
 7872135: () => { return window.innerHeight; },  
 7872162: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 7874340: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 7874644: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 7874748: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 7874919: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 7877796: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 7877869: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 7878269: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 7878319: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 7878458: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
...
var _game_shutdown = Module['_game_shutdown'] = makeInvalidEarlyAccess('_game_shutdown');
var _web_window_size_changed = Module['_web_window_size_changed'] = makeInvalidEarlyAccess('_web_window_size_changed');
var _game_init_window = Module['_game_init_window'] = makeInvalidEarlyAccess('_game_init_window');
var _game_shutdown_window = Module['_game_shutdown_window'] = makeInvalidEarlyAccess('_game_shutdown_window');
var _game_should_run = Module['_game_should_run'] = makeInvalidEarlyAccess('_game_should_run');
var _game_memory = Module['_game_memory'] = makeInvalidEarlyAccess('_game_memory');
var _game_memory_size = Module['_game_memory_size'] = makeInvalidEarlyAccess('_game_memory_size');
var _game_hot_reloaded = Module['_game_hot_reloaded'] = makeInvalidEarlyAccess('_game_hot_reloaded');
var _game_force_reload = Module['_game_force_reload'] = makeInvalidEarlyAccess('_game_force_reload');
var _game_force_restart = Module['_game_force_restart'] = makeInvalidEarlyAccess('_game_force_restart');
...
function assignWasmExports(wasmExports) {
  ...
  _game_init = Module['_game_init'] = createExportWrapper('game_init', 1);
  ...
  _game_step = Module['_game_step'] = createExportWrapper('game_step', 2);
  ...
  assert(typeof wasmExports['game_shutdown'] != 'undefined', 'missing Wasm export: game_shutdown');
  _game_shutdown = Module['_game_shutdown'] = createExportWrapper('game_shutdown', 1);
  ...
  assert(typeof wasmExports['game_init_window'] != 'undefined', 'missing Wasm export: game_init_window');
  _game_init_window = Module['_game_init_window'] = createExportWrapper('game_init_window', 1);
  assert(typeof wasmExports['game_shutdown_window'] != 'undefined', 'missing Wasm export: game_shutdown_window');
  _game_shutdown_window = Module['_game_shutdown_window'] = createExportWrapper('game_shutdown_window', 1);
  assert(typeof wasmExports['game_should_run'] != 'undefined', 'missing Wasm export: game_should_run');
  _game_should_run = Module['_game_should_run'] = createExportWrapper('game_should_run', 1);
  assert(typeof wasmExports['game_memory'] != 'undefined', 'missing Wasm export: game_memory');
  _game_memory = Module['_game_memory'] = createExportWrapper('game_memory', 1);
  assert(typeof wasmExports['game_memory_size'] != 'undefined', 'missing Wasm export: game_memory_size');
  _game_memory_size = Module['_game_memory_size'] = createExportWrapper('game_memory_size', 1);
  assert(typeof wasmExports['game_hot_reloaded'] != 'undefined', 'missing Wasm export: game_hot_reloaded');
  _game_hot_reloaded = Module['_game_hot_reloaded'] = createExportWrapper('game_hot_reloaded', 2);
  assert(typeof wasmExports['game_force_reload'] != 'undefined', 'missing Wasm export: game_force_reload');
  _game_force_reload = Module['_game_force_reload'] = createExportWrapper('game_force_reload', 1);
  assert(typeof wasmExports['game_force_restart'] != 'undefined', 'missing Wasm export: game_force_restart');
  _game_force_restart = Module['_game_force_restart'] = createExportWrapper('game_force_restart', 1);
